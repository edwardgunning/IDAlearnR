...
Once you have installed the package, you should be able to launch the tutorials from the Tutorials pane on the right-hand side of the RStudio IDE (provided that you have a recent version of RStudio installed). 
